...
cap log close
log using $outdir/cox_models_split_2021_gen_2019.txt, replace t
...
tempname measures
	postfile `measures' ///
		...
		using $tabfigdir/cox_model_split_summary_2021_gen_2019, replace
		
use $outdir/combined_covid_2021_general_2019.dta, replace
drop patient_id
...
use $tabfigdir/cox_model_split_summary_2021_gen_2019, replace

export delimited using $tabfigdir/cox_model_split_summary_2021_gen_2019.csv, replace
log close
