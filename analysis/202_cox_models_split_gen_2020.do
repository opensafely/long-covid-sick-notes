...
////////////////////////////////////////////////////////////
//
// 202_cox_models_stsplit_gen_2020.do
//
...
cap log close
log using $outdir/cox_models_split_gen_2020.txt, replace t
...
tempname measures
	postfile `measures' ///
		...
		using $tabfigdir/cox_model_split_summary_gen_2020, replace
		
use $outdir/combined_covid_general_2020.dta, replace
drop patient_id
...
use $tabfigdir/cox_model_split_summary_gen_2020, replace

export delimited using $tabfigdir/cox_model_split_summary_gen_2020.csv, replace
log close
