...
////////////////////////////////////////////////////////////
//
// 202_cox_models_stsplit_2020_pneumo.do
//
...
cap log close
log using $outdir/cox_models_split_2020_pneumo.txt, replace t
...
tempname measures
	postfile `measures' ///
		...
		using $tabfigdir/cox_model_split_summary_2020_pneumo, replace
		
use $outdir/combined_covid_2020_pneumonia.dta, replace
drop patient_id
...
use $tabfigdir/cox_model_split_summary_2020_pneumo, replace

export delimited using $tabfigdir/cox_model_split_summary_2020_pneumo.csv, replace
log close
