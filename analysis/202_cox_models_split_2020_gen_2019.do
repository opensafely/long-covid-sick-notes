...
////////////////////////////////////////////////////////////
//
// 202_cox_models_stsplit_2020_gen_2019.do
//
...
cap log close
log using $outdir/cox_models_split_2020_gen_2019.txt, replace t
...
tempname measures
	postfile `measures' ///
		...
		using $tabfigdir/cox_model_split_summary_2020_gen_2019, replace
		
use $outdir/combined_covid_2020_general_2019.dta, replace
drop patient_id
...
use $tabfigdir/cox_model_split_summary_2020_gen_2019, replace

export delimited using $tabfigdir/cox_model_split_summary_2020_gen_2019.csv, replace
log close
