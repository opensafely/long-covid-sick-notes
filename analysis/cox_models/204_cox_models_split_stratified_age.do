...
////////////////////////////////////////////////////////////
//
// 204_cox_models_split_stratified_age.do
//
...
cap log close
log using $outdir/cox_models_split_${group}_age_group.txt, replace t

tempname measures
	postfile `measures' ///
 		str20(var) str20(category) str20(comparator) str10(adjustment) str10(month) hr lc uc  ///
		ptime_covid events_covid /// 
		ptime_comparator events_comparator  ///
		using $tabfigdir/cox_model_split_summary_${group}_age_group, replace
...
global full i.case##i.month i.male i.ethnicity i.region_9 i.imd /// 
...
levelsof age_group
        ...
        foreach level in `r(levels)' {  
		    ...
		    foreach adjust in crude full {
				...
				stcox $`adjust' if age_group == `level', vce(robust) 
...
use $tabfigdir/cox_model_split_summary_${group}_age_group, replace

export delimited using $tabfigdir/cox_model_split_summary_${group}_age_group, replace
log close
