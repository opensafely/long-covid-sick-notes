...
////////////////////////////////////////////////////////////
//
// 204_cox_models_split_stratified_sex.do
//
// This program runs piecewise Cox models by sex subgroup. 
//
...
levelsof sex
        ...
        foreach level in `r(levels)' {  
		    ...
		    foreach adjust in crude full {
				...
				stcox $`adjust' if sex == `level', vce(robust) 
