...
////////////////////////////////////////////////////////////
//
// 204_cox_models_split_stratified_ethnicity.do
//
// This program runs piecewise Cox models by ethnicity subgroup. 
//
...
cap log close
log using $outdir/cox_models_split_${group}_ethnicity.txt, replace t
...
global full i.case##i.month age1 age2 age3 i.male i.imd i.region_9  /// 
	...
	preserve
        ...
        foreach level in `r(levels)' {  
		    ...
		    foreach adjust in crude full {
				...
				stcox $`adjust' if ethnicity == `level', vce(robust) 
...
use $tabfigdir/cox_model_split_summary_${group}_ethnicity, replace

export delimited using $tabfigdir/cox_model_split_summary_${group}_ethnicity, replace
log close
