...
////////////////////////////////////////////////////////////
//
// 202_cox_models_stsplit_gen_2021.do
//
...
cap log close
log using $outdir/cox_models_split_gen_2021.txt, replace t
...
tempname measures
	postfile `measures' ///
		...
		using $tabfigdir/cox_model_split_summary_gen_2021, replace
		
use $outdir/combined_covid_general_2021.dta, replace
drop patient_id
...
use $tabfigdir/cox_model_split_summary_gen_2021, replace

export delimited using $tabfigdir/cox_model_split_summary_gen_2021.csv, replace
log close
